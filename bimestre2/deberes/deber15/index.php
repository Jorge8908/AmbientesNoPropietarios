    ...
    $(document).ready(function()
    {
        ...
        $.ajax({
            ...
            .done(function(json) {
                ...
                {
                    $('.editinplace').append(
                        "<tr><td class='id'>"+json[i].id+"</td><td class='editable' data-campo='nombre'><span>"+json[i].nombre+"</span></td>" +
                        "<td class='editable' data-campo='email'><span>"+json[i].email+"</span></td>" +
                        "<td class='editable' data-campo='direccion'><span>"+json[i].direccion+"</span></td>" +
                        "<td class='editable' data-campo='provincia'><span>"+json[i].provincia+"</span></td>" +
                        "<td class='editable' data-campo='canton'><span>"+json[i].canton+"</span></td>" +
                        "<td class='editable' data-campo='parroquis'><span>"+json[i].parroquia+"</span></td>" +
                        "<td class='editable' data-campo='usuario'><span>"+json[i].usuario+"</span></td></tr>");
                }
        ...
        $(document).ready(function() {
            $("#kwd_search").keyup(function(){
                if ($(this).val() != "" && $(this).val().length > 1) {
                    $(".editinplace tr>.editable").hide();
                    $(".editinplace td:contains-ci('" + $(this).val() + "')").parent("tr").show();
                } else {
                    $(".editinplace tr>.editable").show();
                }
            });
